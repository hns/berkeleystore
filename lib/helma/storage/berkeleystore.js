...
function Store(location) {
    ...
    function Table(type) {
        ...
        this.store = function(props, entity, txn) {
            // HACK - make sure all indexes used by this object are up
            for (var [prop, value] in props) {
    ...
    function save(props, entity, txn) {
        ...
        if (updateEntity(props, entity, txn)) {
            ...
            getTable(type).store(props, entity, txn);
            if (wrapTransaction) {
                // txn.commit();
            }
        }
